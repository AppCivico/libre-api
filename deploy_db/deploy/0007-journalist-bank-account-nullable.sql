...
ALTER TABLE bank_institution DROP CONSTRAINT bank_institution_pkey CASCADE;
ALTER TABLE bank_institution ADD PRIMARY KEY (code);
ALTER TABLE user_bank_account ADD CONSTRAINT bank_institution_id FOREIGN KEY (bank_institution_id) REFERENCES bank_institution(code);
